...
- Date : 2018-07-18
- Keywords : Dependent type, Categorical model, Programming Language Design.

* Abstract

  - In this work, I am designing language,
  ...
  - When defining a type by giving a typed record a name, it can inherit other types.
    This inheritability means sub-type relation,
    which makes the system suitable to formalize mathematical structures.
