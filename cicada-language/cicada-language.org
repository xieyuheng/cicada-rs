...
*** no construct-exp-t -- generate constructors instead
...
***** den-exe
      ...
      (+fun den-exe
        ...
        (case dup
          ...
          (type-cons-den-t type-den-den-exe)
          (union-cons-den-t union-den-den-exe)))
      #+end_src
...
***** den-cut
      ...
      (+fun den-cut
        ...
        (case dup
          ...
          (type-cons-den-t type-den-den-cut)
          (union-cons-den-t union-den-den-cut)))
      #+end_src
...
*** den->name
    ...
    (+fun den->name
      ...
      (case den
        ...
        (type-cons-den-t den.type-name)
        (union-cons-den-t den.union-name)))
    #+end_src
