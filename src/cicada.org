...
*** test with pass_for_fun -- for arrow
...
***** >< pass_for_fun
      ...
      function pass_for_fun (sexp)
      {
          if (cons_p (sexp) &&
              ...
              let new_body = pass_for_fun_help (arrow_sexp, old_body);
      ...
      function pass_for_fun_help (arrow_sexp, old_body)
      {   
          let local_map = arrow_to_local (arrow_sexp);
