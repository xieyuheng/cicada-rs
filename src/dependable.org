...
*** todo-match-t to done-match-t

    - every time we amend a hypo-obj-t's value

    - then, every time we see a todo-match-t
      we know we can not change it to a done-match-t yet
...
*** [note] obj-match
    ...
    - when .arg of match-exp-t eval to
      ...
      2. hypo-obj-t
         ...
         a new match-obj-t will be created
...
*** [note] match-obj-t & sum-obj-t

    - match-obj-t proxy to match-u
      for the state of match-u
      might can change from todo-match-t to done-match-t

    - the type of todo-match-t
      is sum-obj-t

    - the type of done-match-t
