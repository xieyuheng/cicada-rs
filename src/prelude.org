...
*** exponential-t
    ...
    - with a syntax from `product-t` to `product`
...
*** current principle
    ...
    - x -
      type is part of a record-data
      data is the whole record-data
...
*** category-t
    ...
    category-t = data
      ...
      identity : -- a : object-s -> (arrow-s a a)
...
*** product-closed-category-tt
    ...
    product-closed-category-tt = data <: [category-tt]
      product :
        -- [a b] : object-t
        -> (product-t a b) .product
      arrow-product :
        -- [f g] : (arrow-t a b)
        -> (product-arrow-t f g).product-arrow
    #+end_src
      ...
      unique-factor :
        ...
        -> unique factor : (arrow-t cand.exponential exponential)
           under arrow-eqv-t such-that
             * (arrow-eqv-t
                 cand.eval
                 (compose eval (arrow-product factor identity)))
    #+end_src
