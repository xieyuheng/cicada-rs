...
*** natural-isomorphism -- for category-category

    - natural-transformation whose component are isomorphism
...
*** category-morphism-eqv-tt
    ...
    category-morphism-eqv-tt = data
      lhs : (category-morphism-tt c d)
      rhs : (category-morphism-tt c d)
      ...
      transformation :
        -- f : (c.arrow-t a b)
        -> (d.arrow-eqv-t
             (compose (component a) (rhs.arrow-map f))
             (compose (lhs.arrow-map f) (component b)))
    #+end_src
