...
***** category-ttt.opposite
      ...
      category-ttt.opposite = category-ccc {
        ...
        arrow-eqv-tt : (self.arrow-tt (b a) self.arrow-tt (b a))
          -> type-tt
        ...
        compose : (self.arrow-tt (b a) self.arrow-tt (c b))
          -> self.arrow-tt (c a)
        compose (f g) = self.compose (g f)

        identity-neutral-left : (f : self.arrow-tt (b a))
          -> arrow-eqv-tt (f self.compose (f identity))
        identity-neutral-left = self.identity-neutral-right

        identity-neutral-right : (f : self.arrow-tt (b a))
