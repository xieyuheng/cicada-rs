...
#+title: core
- def a define in core
  as new interface for module system
  - only by doing this
    we can implement the module system in jojo code
    instead of c code
- <table>
...
*** note stacks
    ...
    - to solve prefix problem for dependent modules
      ...
      - prefix-stack
        ...
        (use module-name [version] ...) push prefix-stack
        to make an unique "module[version]." prefix
        can be used as "module."

        pop prefix-stack after loading

*** module_stack

    - a stack to record current loading module
...
*** defining_stack
    ...
    - a stack of names defined by current loading module
