...
*** module-load
    ...
    (+jojo module-load (-> :name --)
      "HOME" find-env-string
      (if not then
          "- module-load fail" w nl
          "  system env variable HOME empty" w nl
          "  trying to load : " w :name w nl
          debug)
      "/.jojo/modules/" string-append
      :name jo->string string-append
      "/module.jo" string-append
      path-load)
    #+end_src
