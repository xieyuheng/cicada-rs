...
*** <int>
    ...
    (define-class <int>
      (method
        (* inc (<< self) drop inc (jo <int>))
        (* dec (<< self) drop dec (jo <int>))
        (* neg (<< self) drop neg (jo <int>))

        (* (: add: i) (<< self) drop (<< i) drop add (jo <int>))
        (* (: sub: i) (<< self) drop (<< i) drop sub (jo <int>))
        (* (: mul: i) (<< self) drop (<< i) drop mul (jo <int>))
        (* (: div: i) (<< self) drop (<< i) drop div (jo <int>))
        (* (: mod: i) (<< self) drop (<< i) drop mod (jo <int>))

        (* (: eq?: i) (<< self) drop (<< i) drop eq?)
        (* (: gt?: i) (<< self) drop (<< i) drop gt?)
        (* (: lt?: i) (<< self) drop (<< i) drop lt?)
        (* (: gteq?: i) (<< self) drop (<< i) drop gteq?)
        (* (: lteq?: i) (<< self) drop (<< i) drop lteq?)

        (* print (<< self) drop integer/print)
        (* dot (<< self) drop integer/dot)
...
*** <str>
    ...
    (define-class <str>
      (method
        (* print (<< self) drop string/print)
        (* length (<< self) drop string/length (jo <int>))
        (* write
...
*** note
    ...
    (note
      ...
      (add-method <path> open-for-reading
        (<< self) drop string/open-for-reading)
